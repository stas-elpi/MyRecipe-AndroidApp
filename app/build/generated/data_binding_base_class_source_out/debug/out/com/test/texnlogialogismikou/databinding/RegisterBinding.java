...
public final class RegisterBinding implements ViewBinding {
  ...
  private RegisterBinding(@NonNull ConstraintLayout rootView, @NonNull EditText input1,
      @NonNull EditText input2) {
  ...
  public static RegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RegisterBinding((ConstraintLayout) rootView, input1, input2);
    }
